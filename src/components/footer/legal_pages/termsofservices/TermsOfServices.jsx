	...
	return (
		<div className="terms">
			...
			<p>
				...
				droits et obligations de la société ... (dénomination sociale) et de son
				client dans le cadre de la vente des marchandises suivantes : ... (le
				vendeur doit recenser les marchandises soumises aux CGV).
			</p>

			<p>
				Toute acceptation du devis/bon de commande en ce compris la clause « Je
				reconnais avoir pris connaissance et j'accepte les conditions générales
				de vente ci-annexées » implique l'adhésion sans réserve de l'acheteur
			...
			<p>
				La société ... (dénomination sociale) s'accorde le droit de modifier ses
			...
			<p>
				...
				... (dénomination sociale) serait amenée à octroyer compte tenu de ses
			...
			<p>le cas échéant, indiquer les autres moyens de paiement acceptés.</p>

			<p>Les règlements seront effectués aux conditions suivantes :</p>

			<p>Paiement à 30 jours suivant la réception des marchandises&nbsp;</p>
			...
			<p>Paiement à 60 jours suivant la date de facturation&nbsp;</p>

			<h3>Clause n° 6 : Retard de paiement</h3>

			<p>
				En cas de défaut de paiement total ou partiel des marchandises livrées à
				l'échéance, l'acheteur doit verser à la société ... (dénomination
				sociale) une pénalité de retard égale à trois fois le taux de l'intérêt
				légal.
			</p>
			...
			<p>
				...
				les 6 mois (Ordonnance n°2014-947 du 20 août 2014).
			</p>
			...
			<p>
				La société ... (dénomination sociale) conserve la propriété des biens
				...
				d'une liquidation judiciaire, la société ... (dénomination sociale) se
			...
			<p>soit par la remise directe de la marchandise à l'acheteur ;</p>
			<p>
				soit par l'envoi d'un avis de mise à disposition en magasin à
				l'attention de l'acheteur ;
			</p>
			<p>
				soit par le dépôt de la marchandise&nbsp;au lieu indiqué par l'acheteur
			...
			<p>l'allocation de dommages et intérêts ;</p>
			<p>l'annulation de la commande.</p>
			...
			<p>
				La responsabilité de la société ... (dénomination sociale) ne pourra pas
				être mise en oeuvre si la non-exécution ou le retard dans l'exécution de
				l'une de ses obligations décrites dans les présentes conditions
			...
			<p>
				...
				de commerce ... (lieu du siège social).
			</p>

			<p> Fait à Nantes, le 29/09/2022</p>
		</div>
	);
}
